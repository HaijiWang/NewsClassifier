...
public class MyTest2 {
	...
	public static final String SOLR_URL = "http://172.24.60.110:8983/solr/test/";
	...
	public static void AddDocs() {
		...
		Collection<SolrInputDocument> docs = new ArrayList<SolrInputDocument>();
			...
			doc1.addField("id", "cn.njdaily.www:http/2012/0425/130369.shtml");
			
			doc1.addField("machine", "mmmmm");
			docs.add(doc1);
